...
public class DrMario
{
    public static void main(String[] args)
    {
        ...
        g.fillRect(85, 10, 70, 10);//
        g.fillRect(65, 20, 20, 10);//
        g.fillRect(155, 20, 20, 10);//
        g.fillRect(55, 30, 10, 10);//
        g.fillRect(175, 30, 10, 10);//
        g.fillRect(55, 40, 10, 10);//
        g.fillRect(175, 40, 10, 10);//
        g.fillRect(45, 50, 10, 10);//
        g.fillRect(95, 50, 10, 10);//
        g.fillRect(135, 50, 10, 10);//
        g.fillRect(185, 50, 10, 10);//
        g.fillRect(45, 60, 10, 10);//
        g.fillRect(105, 60, 30, 10);//
        g.fillRect(185, 60, 10, 10);//
        g.fillRect(35, 70, 10, 10);//
        g.fillRect(85, 70, 20, 10);//
        g.fillRect(135, 70, 20, 10);//
        g.fillRect(195, 70, 10, 10);//
        g.fillRect(25, 80, 10, 10);//
        g.fillRect(75, 80, 10, 10);//
        g.fillRect(155, 80, 10, 10);//
        g.fillRect(205, 80, 10, 10);//
        ...
        g.fillRect(85, 20, 20, 10);//
        g.fillRect(135, 20, 20, 10);//
        g.fillRect(65, 30, 30, 10);// 
        g.fillRect(145, 30, 30, 10);//
        g.fillRect(65, 40, 30, 10);// 
        g.fillRect(145, 40, 30, 10);//
        g.fillRect(55, 60, 50, 10);//
        g.fillRect(135, 60, 50, 10);//
        g.fillRect(45, 70, 20, 10);//
        g.fillRect(75, 70, 10, 10);//
        g.fillRect(155, 70, 10, 10);//
        g.fillRect(175, 70, 20, 10);//
        g.fillRect(55, 80, 10, 10);//
        g.fillRect(175, 80, 10, 10);//
        ...
        g.fillRect(105, 20, 30, 10);//
        g.fillRect(95, 30, 50, 10);//
        g.fillRect(95, 40, 50, 10);//
        g.fillRect(55, 50, 40, 10);//
        g.fillRect(105, 50, 30, 10);//
        g.fillRect(145, 50, 40, 10);//
        g.fillRect(85, 80, 30, 10);//
        g.fillRect(125, 80, 30, 10);//
        ...
        g.fillRect(105, 70, 30, 10);//
        g.fillRect(165, 70, 10, 10);//
        g.fillRect(35, 80, 20, 10);//
        g.fillRect(65, 80, 10, 10);//
        g.fillRect(115, 80, 10, 10);//
        g.fillRect(165, 80, 10, 10);//
        g.fillRect(185, 80, 20, 10);//
